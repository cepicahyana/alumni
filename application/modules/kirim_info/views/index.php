 ...
 var  dataTable = $('#table').DataTable({
   ...
   buttons: [
...

      {
       ...
       "ajax": {
           "url": "<?php echo site_url('Kirim_info/getData');?>",
           "type": "POST",
     "data": function ( data ) {
...
function tambah(){
    ...
    $.post("<?php echo base_url() ?>kirim_info/form_tambah", function(data, status){
    $("#mdlValue").html(data);
   });
}
...
function edit(id){
    $("#mdl_formSubmit").modal();
    $("#mdlValue").html("mohon tunggu...");
    $.post("<?php echo base_url() ?>kirim_info/form_edit",{id:id}, function(data, status){
    $("#mdlValue").html(data);
   });
}
</script>
...
<script>
 ...
 $.post("<?php echo base_url() ?>kirim_info/hapus",{id:id}, function(data, status){

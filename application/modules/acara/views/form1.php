...
<div class="col-sm-10">
<input type="text" name="f[nama_acara]" required class="form-control">
</div>
</div> 
...
<div class="col-sm-10">
<input type="text"  name="tgl" id="tgl" class="form-control"  autocomplete="false" autocomplete="off" autocomplete="nope" >
</div>
</div> 
...
<div class="col-sm-10">
<input type="text" name="f[jam]" id="tgl" class="form-control hour" data-mask="99:99">
</div>
</div> 

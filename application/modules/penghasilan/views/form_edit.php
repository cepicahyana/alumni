...
$this->db->where("id",$id);
$db	=	$this->db->get("tr_penghasilan")->row();
?>
<div class="row" id="area_formSubmit">
	<div class="col-sm-12"> 
		...
		url="<?php echo base_url()?>penghasilan/update">
				<input type="hidden" name="id" value="<?php echo $db->id;?>">
				<div class="form-group row">
					<label class="col-sm-4 col-form-label">Penghasilan </label>
						<div class="col-sm-8">
							<input type="text" name="f[penghasilan]" value="<?php echo $db->penghasilan ?>"   required class="form-controls">
						</div>
				</div> 

 ...
 <th>ACTION</th>
  ...
  var  dataTable = $('#table').DataTable({ 
	  ...
	  dom: 'Blfrtip',
        ...
        "ajax": {
            "url": "<?php echo site_url('penghasilan/getData');?>",
            "type": "POST",
			"data": function ( data ) {
...
function tambah(){
		 ...
		 $.post("<?php echo base_url() ?>penghasilan/form_tambah", function(data, status){
		 $("#mdlValue").html(data);
	  }); 
}   
</script>
...
function edit(id){
		 $("#mdl_formSubmit").modal();
		 $("#mdlValue").html("mohon tunggu...");  
		 $.post("<?php echo base_url() ?>penghasilan/form_edit",{id:id}, function(data, status){
		 $("#mdlValue").html(data);
	  }); 
}   
</script>
...
<script>
  function hapus(id,nama){  
	...
	$.post("<?php echo base_url() ?>penghasilan/hapus",{id:id}, function(data, status){ 

 ...
 <th>ACTION</th>
  ...
  var  dataTable = $('#table').DataTable({ 
	  ...
	  dom: 'Blfrtip',
        ...
        "ajax": {
            "url": "<?php echo site_url('profesi/getData');?>",
            "type": "POST",
			"data": function ( data ) {
...
function tambah(){
		 ...
		 $.post("<?php echo base_url() ?>profesi/form_tambah", function(data, status){
		 $("#mdlValue").html(data);
	  }); 
}   
</script>
...
function edit(id){
		 $("#mdl_formSubmit").modal();
		 $("#mdlValue").html("mohon tunggu...");  
		 $.post("<?php echo base_url() ?>profesi/form_edit",{id:id}, function(data, status){
		 $("#mdlValue").html(data);
	  }); 
}   
</script>
...
<script>
  function hapus(id,nama){  
	...
	$.post("<?php echo base_url() ?>profesi/hapus",{id:id}, function(data, status){ 

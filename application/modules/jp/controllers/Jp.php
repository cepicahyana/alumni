...
class Jp extends CI_Controller 
{
	...
	{ 	
		...
		if($ajax=="yes")
		{
			...
			$data['header']="Data Jenjang Pendidikan";
			$data['konten']="index";
			$this->_template($data);
		}
	...
	function getData(){
		...
		$id	= $dataDB->id; 
		 $action		 =	'<div class="btn-group" role="group"  >
								 <button onclick="hapus(`'.$dataDB->id.'`,`'.$dataDB->nama.'`)" type="button" class="btn bg-grey  btn-sm waves-effect waves-light ti-trash"> <i title="hapus" class="ri-delete-bin-7-fill"></i>   </button>

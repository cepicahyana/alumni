 ...
 var  dataTable = $('#table').DataTable({
   ...
   buttons: [
...

      {
       ...
       "ajax": {
           "url": "<?php echo site_url('data_kelas/getData');?>",
           "type": "POST",
     "data": function ( data ) {
...
function tambah(){
    ...
    $.post("<?php echo base_url() ?>data_kelas/form_tambah", function(data, status){
    $("#mdlValue").html(data);
   });
}
...
function edit(id){
    $("#mdl_formSubmit").modal();
    $("#mdlValue").html("mohon tunggu...");
    $.post("<?php echo base_url() ?>data_kelas/form_edit",{id:id}, function(data, status){
    $("#mdlValue").html(data);
   });
}
</script>
...
<script>
 ...
 $.post("<?php echo base_url() ?>data_kelas/hapus",{id:id}, function(data, status){

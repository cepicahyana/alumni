...
<div class="row" id="area_formSubmit">
	<div class="col-sm-12">
		...
		url="<?php echo base_url()?>data_kelas/update">
				<input type="hidden" name="id" value="<?php echo $db->id;?>">
				<div class="form-group row">
					<label class="col-sm-4 col-form-label">Kelas </label>
						<div class="col-sm-8">
							<input type="text" name="f[id_tingkat]" value="<?php echo $db->id_tingkat?>"   required class="form-controls">
						</div>
				</div>
				<div class="form-group row">
					<label class="col-sm-4 col-form-label">Nama  </label>
						<div class="col-sm-8">
							<input type="text" name="f[nama_kelas]" value="<?php echo $db->nama_kelas ?>"   required class="form-controls">
						</div>
				</div>

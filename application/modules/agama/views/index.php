...
function tambah(){
		 ...
		 $.post("<?php echo base_url() ?>agama/form_tambah", function(data, status){
		 $("#mdlValue").html(data);
	  }); 
}   
</script>
...
function edit(id){
		 $("#mdl_formSubmit").modal();
		 $("#mdlValue").html("mohon tunggu...");  
		 $.post("<?php echo base_url() ?>agama/form_edit",{id:id}, function(data, status){
		 $("#mdlValue").html(data);
	  }); 
}   
</script>
...
<script>
  function hapus(id,nama){  
	...
	$.post("<?php echo base_url() ?>agama/hapus",{id:id}, function(data, status){ 
